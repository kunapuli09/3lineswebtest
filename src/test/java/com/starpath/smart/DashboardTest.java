...
//        Assert.assertNotNull(successMessage);
    ...
    /**
     * Tests as Admin User
     * Should have capabilities to add new investment and links to Investments, Investors, Investor Documents, and Deals pages.
     * Dashboard page should show Admin View of Companies and the two cards with total investments
     * Check hover features
     */

    @Test
    public void testAddNewInvestmentButton() throws InterruptedException {
        /*
         * Test if button appears for admins
         */
    }
    @Test
